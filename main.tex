...
{
  name=App Shell,
  description={Squelette de l'application. Voir figure~\ref{fig: App Shell}}
}
...
\insererfigure{figures/lambertCC_mercator84_merged.png}{3cm}{
  Projection Lambert conique conforme / Projection Mercator\\
...
\insererfigure{figures/architecture-SIG.png}{11cm}{Architecture
  \gls{sig} de l'entreprise}{Architecture SIG}
...
carte. \insererfigure{figures/homescreen.png}{4cm}{Choix de la vue selon le
  type de géométrie}{Map-Viewer}
...
mockés: une réponse \og{type} \fg{} avec des données statiques est renvoyé au
...
\insererfigure{figures/proto_app-shell.png}{3.5cm}{\Gls{appshell}}{App Shell}
...
\insererfigure{figures/proto_type-select.png}{1.5cm}{Composant de recherche de
  types / contextes}{Composant de recherche de types et contextes}
...
% \insererfigure{figures/screen_mm_import.png}{7.5cm}{Vue de l'import

...
\begin{description}
  \item[la définition d'un référentiel] dont son but est de fournir aux utilisateurs
    ...
    \insererfigure{figures/rgf93rbf.jpeg}{6.5cm}{Sites constituant le réseau de
      base français pour maintenir le RGF93}{Les sites constituant le réseau de base
      français}
...
contextes: \insererfigure{figures/proto_type-select.png}{1.5cm}{Composant de
  recherche de types / Composant de visualisation du contenu du Type}{Capture
  d'écran Composant de recherche de types à gauche et composant de visualisation
  du contenu du type à droite}
